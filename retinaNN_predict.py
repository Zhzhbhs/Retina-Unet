...
# Add the 'lib' folder to the Python module search path
import sys
sys.path.insert(0, './lib')  # Add the lib folder to the system path

# Now we can import help_functions without issue
from help_functions import load_hdf5, pred_to_imgs  # Import pred_to_imgs here
...
# Pre-processing
from lib.help_functions import masks_Unet
from lib.help_functions import rgb2gray
...
#===== Convert the prediction arrays into corresponding images
